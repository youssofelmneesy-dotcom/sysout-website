    ...
    <section id="contact" ref={ref} className="relative py-24 bg-gradient-to-b from-black via-purple-950/20 to-black">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:youssofelmneesy@gmail.com"
          ...
          {/* Send Message action (form removed by request) */}
          <motion.div
            initial={{ opacity: 0, x: 50 }}
            animate={isInView ? { opacity: 1, x: 0 } : { opacity: 0, x: 50 }}
            transition={{ duration: 0.6 }}
            className="flex flex-col justify-center items-center text-center bg-gradient-to-br from-purple-900/20 to-blue-900/20 border border-purple-500/30 rounded-2xl p-10"
          >
            <Send className="w-12 h-12 text-purple-400 mb-6" />
            <h3
            ...
            <p
              ...
              style={{ fontFamily: 'Rajdhani, sans-serif' }}
            >
              Click below to send us an email directly and we'll get back to you as soon as possible.
            </p>
            <motion.a
              href="mailto:youssofelmneesy@gmail.com"
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="w-full max-w-xs py-4 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-xl flex items-center justify-center gap-2 hover:from-purple-500 hover:to-blue-500 transition-all duration-300"
            >
              <span style={{ fontFamily: 'Rajdhani, sans-serif' }}>
                Send Message
              </span>
          ...
          {/*
            الفورم الأصلي اتشال بناءً على طلبك، الكود محفوظ هنا لو حبيت ترجعه تاني.
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label htmlFor="name" className="block text-purple-300 mb-2" style={{ fontFamily: 'Rajdhani, sans-serif' }}>
                  Name
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="email" className="block text-purple-300 mb-2" style={{ fontFamily: 'Rajdhani, sans-serif' }}>
                  Email
                </label>
                <input
                  type="email"
              ...
              <div>
                <label htmlFor="businessType" className="block text-purple-300 mb-2" style={{ fontFamily: 'Rajdhani, sans-serif' }}>
                  Business Type
                </label>
                <select
                  id="businessType"
              ...
              <div>
                <label htmlFor="message" className="block text-purple-300 mb-2" style={{ fontFamily: 'Rajdhani, sans-serif' }}>
                  Message
                </label>
                <textarea
                  id="message"
